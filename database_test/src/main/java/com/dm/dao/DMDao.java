...
public class DMDao {
	...
	private static String DM7_driver = "dm.jdbc.driver.DmDriver";
	private static String DM7_connectUrl = "jdbc:dm://192.168.2.52:5236/SYSTEM";
	private static String DM7_name = "SYSDBA";
	private static String DM7_password = "damengroot";

    private static String optkey = "dm7";
    private static String dateString = "now()";
    
    private static String DELETE = "delete from SYSTEM.TEST_TABLE where USER_ID=1";
    private static String INSERT = "insert into SYSTEM.TEST_TABLE (USER_NAME,USER_BIRTHDAY) values ('" + optkey + "_insert'," + dateString + ")";
    private static String SELECT_INSERT = "select USER_ID,USER_NAME,USER_BIRTHDAY from SYSTEM.TEST_TABLE where USER_NAME like '%" + optkey + "%'";
    private static String UPDATE = "update SYSTEM.TEST_TABLE set USER_NAME='" + optkey + "_update' where USER_NAME = '" + optkey + "_insert'";
    private static String SELECT_UPDATE = "select USER_ID,USER_NAME,USER_BIRTHDAY from SYSTEM.TEST_TABLE where USER_NAME like '%" + optkey + "%'";
