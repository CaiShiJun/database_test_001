...
public class OracleJdbcTemplateController{
    ...
    String insertsql = "insert into test_user(id,name,birthday) values(1,?,to_date('2004-05-07 13:23:44','YYYY-MM-DD HH24:MI:SS'))";
    ...
    public String test(HttpServletResponse resp) {
        ...
        OracleTemplate.update(insertsql, new Object[]{1});
